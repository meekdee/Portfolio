...
import { faAt, faEnvelope, faInbox } from "@fortawesome/free-solid-svg-icons";
import {
  faFacebook,
  faGithub,
  faLinkedin,
...
const socials = [
  {
    icon: faInbox,
    url: "emailto: drewaju.16@gmail.com",
  },
  {
    icon: faGithub,
    url: "https://github.com/meekdee/",
  },
  {
    icon: faLinkedin,
    url: "https://www.linkedin.com/in/azeez-olarewaju-6884b5237/",
  },
  {
    icon: faWhatsapp,
    url: "https://wa.me/09039254894",
  },
  {
    icon: faFacebook,
